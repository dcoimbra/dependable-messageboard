...
public class AnnouncementTest {
    ...
    public void validAnnouncement() {
        try {
            _announcement = new Announcement(_publicKey, _message, _quotedAnnouncements, _nonce, _signature, _counter);
    ...
    public void validAnnouncement254() {
        ...
        try {
            _announcement = new Announcement(_publicKey, repeated, _quotedAnnouncements, _nonce, _signature, _counter);
    ...
    public void invalidAnnouncement() {
        assertThrows(RemoteException.class,
                () -> new Announcement(_publicKey, new String(new char[256]), _quotedAnnouncements, _nonce, _signature, _counter));
    }

    @Test
    public void invalidAnnouncementNullPubKey() {
        assertThrows(RemoteException.class,
                () -> _announcement = new Announcement(null, _message, _quotedAnnouncements, _nonce, _signature, _counter));
    }

    @Test
    public void invalidAnnouncementNullMessage() {
        assertThrows(RemoteException.class,
                () -> new Announcement(_publicKey, null, _quotedAnnouncements, _nonce, _signature, _counter));
    }

    @Test
    public void invalidAnnouncementNullQuotedAnnouncements() {
        assertThrows(RemoteException.class,
                () -> new Announcement(_publicKey, _message, null, _nonce, _signature, _counter));
    }
}
